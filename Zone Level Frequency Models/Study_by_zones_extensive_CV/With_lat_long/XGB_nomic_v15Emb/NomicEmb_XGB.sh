#!/bin/bash
#SBATCH --job-name=xgb_nomicv15emb
#SBATCH --array=0-5 #0-5 testing 
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=05:30:00
#SBATCH --account=def-cbravo
#SBATCH --output=XGB_nomicv15emb.%A_%a.out
...
OUT_DIR="/home/salfonso/scratch/Belgian/Study_by_zones_extensive_CV/With_lat_long/XGB_nomic_v15Emb/Results"
...
# Message if none found (helps catch wrong file or prefix)
if not emb:
