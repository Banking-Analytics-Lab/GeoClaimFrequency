#!/bin/bash
#SBATCH --job-name=glmreg_resnet18emb
#SBATCH --array=0-5 #0-5
#SBATCH --cpus-per-task=1
#SBATCH --mem=8G
#SBATCH --time=02:30:00
#SBATCH --account=def-cbravo
#SBATCH --output=Poisson_GLM_resnet18emb.%A_%a.out
...
OUT_DIR="/home/salfonso/scratch/Belgian/Study_by_zones_extensive_CV/With_lat_long/GLM_reg_ResNet18Emb/Results"
...
#helps found if embedding features are not in the data set
if not emb:
