...
NUM_VARS = "[]"
CAT_VARS = "None"
BASE_OUT_ROOT = "/home/salfonso/scratch/Belgian/Study_by_zones_extensive_CV/ONLY_images"
...
PYTHON_SCRIPT = "/home/salfonso/projects/rrg-cbravo/salfonso/Project3/Study_by_zones_extensive_CV_1025/Models_frequency/Imagenes_DNN/MResNet18_extcv_single_config_ONLY_images.py"
...
OUTPUT_FOLDER = "/home/salfonso/scratch/Belgian/Study_by_zones_extensive_CV/ONLY_images/Neigh_0.5"
os.makedirs(OUTPUT_FOLDER, exist_ok=True)

# Generate the template 
template = dedent("""\
    #!/bin/bash
    #SBATCH --job-name=N{radius}_out{outer}_img_sc_ep{epochs}
    {gpu_line}
    {cpus_line}
    {mem_line}
